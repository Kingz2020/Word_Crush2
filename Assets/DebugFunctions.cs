...
public class DebugFunctions: MonoBehaviour {
    ...
    [SerializeField] private TileBag2 tileBag;
    ...
    public void DisplayRecordedPositions() {
        foreach (var tileMove in boardScript.recordedPositions) {
            ...
            Debug.Log("Letter: " + tileMove.gameObject.GetComponent<TileScript2>().GetLetter());
        }
    }
    ...
    public void PrintHandTiles() {
        ...
        foreach (TileScript2 tile in tileBag.handTiles) {
